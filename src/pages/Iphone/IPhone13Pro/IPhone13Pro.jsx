...
import s from './IPhone13Pro.module.scss'
import w from '../../../img/iphone/iPhone13ProMax/a.webp'
import q from '../../../img/iphone/iPhone13ProMax/b.webp'
  ...
  return (
    <div className={s.block}>
        ...
        <div className={s.block2}>
            ...
            <p>Цвет</p>
            <div className={s.btn}>
            <button className={s.b} onClick={()=>setImg(q)}></button>
            <button className={s.a} onClick={()=>setImg(w)}></button>
            ...
            <div className={s.pamit}>
                ...
                <button onClick={()=>setText(v)}>512 gb</button>
